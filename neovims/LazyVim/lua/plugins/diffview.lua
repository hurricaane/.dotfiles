return {
  ...
  config = function()
    -- Check default configuration: https://github.com/sindrets/diffview.nvim?tab=readme-ov-file#configuration
    -- Check usage: https://github.com/sindrets/diffview.nvim/blob/main/USAGE.md
